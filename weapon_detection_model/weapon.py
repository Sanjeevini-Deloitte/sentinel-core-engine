...
model = torch.hub.load('C://Users//Administrator//Desktop//ml_models//yolov5-master', 'custom',
                       path='C://Users//Administrator//Desktop//ml_models//pt files//weapons.pt',
                       source="local")

classes = model.names


def weapon_recognisation(ret, frame):
    # accuracy threshold
    acc = 0.45
    ...
    if ret:
        ...
        frame = color_box("weapon", "gun", res, frame, classes=classes, acc=acc)
