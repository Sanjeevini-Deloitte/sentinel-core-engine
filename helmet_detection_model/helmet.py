...
model = torch.hub.load('C://Users//Administrator//Desktop//ml_models//yolov5-master', 'custom',
                       path='C://Users//Administrator//Desktop//ml_models//pt files//besthelmet.pt',
                       source="local")

classes = model.names


def helmet_recognisation(ret, frame):
    # accuracy threshold
    acc = 0.45
    ...
    if ret:
        ...
        frame = color_box("helmet", "without Helmet", res, frame, classes=classes, acc=acc)
