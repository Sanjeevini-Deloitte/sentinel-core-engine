...
model = torch.hub.load('C://Users//Administrator//Desktop//ml_models//yolov5-master', 'custom',
                       path='C://Users//Administrator//Desktop//ml_models//pt files//fire_and_smoke.pt',
                       source="local")

classes = model.names


def fire_smoke_recognisation(ret, frame):
    # accuracy threshold
    acc = 0.45
    ...
    if ret:
        ...
        frame = color_box("fire_smoke", "Smoke", res, frame, classes=classes, acc=acc)
        frame = color_box("fire_smoke", "Fire", res, frame, classes=classes, acc=acc)
